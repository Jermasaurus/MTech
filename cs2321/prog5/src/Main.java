...
public class Main extends JPanel {
    ...
    public Main( ) {
        maze = new MyMaze( );
        System.out.println( "Maze Constructed" );
        maze.generateMaze( rows, columns );
        System.out.println( "Maze Generated" );
        System.out.println( "maze.toString( ):\n" + maze );
        System.out.println( "maze.toGraph.toString( ):\n" + maze.toGraph( ) );
        path = maze.solveMaze( );
        ...
        for ( int r = 0; r < rows; r++ ) {
            for ( int c = 0; c < columns; c++ ) {
                if ( ( c == 0 ) || ( !graph.areConnected( map[r][c], map[r][c - 1] ) ) ) {
                    ...
                    g2.setStroke( new BasicStroke( 5 ) );
                    g2.drawLine( (int) ( c * w + w ), (int) ( r * h + h ), (int) ( c * w + w ),
                            (int) ( ( r + 1 ) * h + h ) );
                }
                if ( ( c == columns - 1 ) || ( !graph.areConnected( map[r][c], map[r][c + 1] ) ) ) {
                    g2.setColor( Color.BLACK );
                    g2.setStroke( new BasicStroke( 5 ) );
                    g2.drawLine( (int) ( ( c + 1 ) * w + w ), (int) ( r * h + h ), (int) ( ( c + 1 ) * w + w ),
                            (int) ( ( r + 1 ) * h + h ) );
                }
                if ( ( r == 0 ) || ( !graph.areConnected( map[r][c], map[r - 1][c] ) ) ) {
                    g2.setColor( Color.BLACK );
                    g2.setStroke( new BasicStroke( 5 ) );
                    g2.drawLine( (int) ( c * w + w ), (int) ( r * h + h ), (int) ( ( c + 1 ) * w + w ),
                            (int) ( r * h + h ) );
                }
                if ( ( r == rows - 1 ) || ( !graph.areConnected( map[r][c], map[r + 1][c] ) ) ) {
                    g2.setColor( Color.BLACK );
                    g2.setStroke( new BasicStroke( 5 ) );
                    g2.drawLine( (int) ( c * w + w ), (int) ( ( r + 1 ) * h + h ), (int) ( ( c + 1 ) * w + w ),
                            (int) ( ( r + 1 ) * h + h ) );
                }
            }
        }
