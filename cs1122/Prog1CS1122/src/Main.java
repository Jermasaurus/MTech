...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		// look up distances between location IDs from a file
		nav.processFile("inputList.txt", "output_file.txt");
		printFile("output_file.txt");
		System.out.println();

		// Call extra credit method
		System.out.println("Path from New York to Houghton is: '"
				+ nav.bestPath("New York", "Houghton") + "'");
		System.out.println("Path from Houghton to New York is: '"
				+ nav.bestPath("Houghton", "New York") + "'");
	}
